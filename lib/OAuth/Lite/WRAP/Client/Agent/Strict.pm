package OAuth::Lite::WRAP::Client::Agent::Strict;

use strict;
use warnings;

use base 'OAuth::Lite::WRAP::Client::Agent';
use OAuth::Lite::WRAP::Client::Error;

=head1 NAME

OAuth::Lite::WRAP::Client::Agent::Strict - Preset User Agent class for strict SSL

=head1 SYNOPSIS

    my $client = OAuth::Lite::WRAP::Client::WebApp->new(
        ..., # other params
        agent => OAuth::Lite::WRAP::Client::Agent::Strict->new(
...
sub request {
    ...
    OAuth::Lite::WRAP::Client::Error::InsecureRequest->throw(
    ...
    OAuth::Lite::WRAP::Client::Error::InsecureResponse->throw(
...
L<OAuth::Lite::WRAP::Client::Agent>,
L<OAuth::Lite::WRAP::Client::Agent::Dump>
