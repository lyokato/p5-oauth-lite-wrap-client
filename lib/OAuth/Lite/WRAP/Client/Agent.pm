package OAuth::Lite::WRAP::Client::Agent;
...
OAuth::Lite::WRAP::Clinet::Agent - Base class of preset-agents.

=head1 SYNOPSIS

    my $agent = OAuth::Lite::WRAP::Clinet::Agent->new;
...
sub new {
    ...
    unless ($self->{agent}) {
        ...
        $self->{agent}->agent(
            join "/",
                __PACKAGE__,
                $OAuth::Lite::WRAP::Clinet::VERSION
        );
    }
    return $self;
}
...
L<OAuth::Lite::WRAP::Client::Agent::Strict>
