...
my $client = OAuth::Lite::WRAP::Client::WebApp->new(
    ...
    authorize_url     => q{https://www.google.com/accounts/WrapUserAuthorization},
    access_token_url  => q{https://www.google.com/accounts/WrapAccessToken},
    refresh_token_url => q{https://www.google.com/accounts/WrapRefreshToken},
